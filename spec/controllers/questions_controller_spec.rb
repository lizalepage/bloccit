...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Questions by 1" do
      expect {post :create, params: { question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false, id: 2} } }.to change(Question,:count).by(1)
    end
    
    it "assigns new question to @question" do
      post :create, params: { question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false, id: 2} } 
